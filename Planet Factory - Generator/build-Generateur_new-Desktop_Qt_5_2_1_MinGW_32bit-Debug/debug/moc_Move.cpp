/****************************************************************************
** Meta object code from reading C++ file 'Move.hpp'
**
...
#include "../../Generateur_new/Move.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Move.hpp' doesn't include <QObject>."
...
void Move::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Move::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Move::step3sign)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Move::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Move.data,
