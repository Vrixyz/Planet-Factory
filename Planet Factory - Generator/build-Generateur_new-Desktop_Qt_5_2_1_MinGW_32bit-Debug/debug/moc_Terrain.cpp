/****************************************************************************
** Meta object code from reading C++ file 'Terrain.hpp'
**
...
#include "../../Generateur_new/Terrain.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Terrain.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Terrain_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 19, 9)
    ...
    "Terrain\0step2sign\0\0step3sign\0"
};
...
void Terrain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->step2sign(); break;
        case 1: _t->step3sign(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Terrain::step2sign)) {
                *result = 0;
            }
        }
        {
            typedef void (Terrain::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Terrain::step3sign)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Terrain::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Terrain.data,
...
// SIGNAL 0
void Terrain::step2sign()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Terrain::step3sign()
{
